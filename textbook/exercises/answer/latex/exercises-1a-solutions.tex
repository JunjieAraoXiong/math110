...
\begin{solution}
Let $\omega = \frac{-1 + \sqrt{3}\,i}{2}$. We compute $\omega^3$ step by step.
...
\begin{solution}
We seek $z = a + bi$ such that $z^2 = i$, where $a, b \in \R$.
...
\begin{solution}
Let $\alpha = a + bi$ where $a, b \in \R$ and $a$ and $b$ are not both zero.
